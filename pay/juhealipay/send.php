...
$notify_url='http://'.$_SERVER['HTTP_HOST'].'/pay/juhealipay/notify.php';//异步通知地址
$return_url='http://'.$_SERVER['HTTP_HOST'].'/pay/juhealipay/return.php';//异步通知地址
			...
			$paymoney =$total_fee;//单位元（人民币）,两位小数点
			$ordernumber =$sdorderno;//商户系统订单号，该订单号将作为接口的返回数据。该值需在商户系统内唯一
