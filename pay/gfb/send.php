...
require_once 'yeepayCommon.php';
            ...
            $apiurl			=	"http://api.7zcyl.com/PayBank.aspx";	//网关接口地址
            ...
            $callbackurl	= "http://".$_SERVER['HTTP_HOST']."/pay/gfb/notifyUrl.php"; //服务器异步通知页面路径
			
            $hrefbackurl	= "http://".$_SERVER['HTTP_HOST']."/pay/gfb/returnUrl.php"; //页面跳转同步通知页面路径
