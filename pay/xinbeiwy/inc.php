...
function GetBankCode($bankid){
	$bankcode="";
	if($bankid=='ICBC') $bankcode="100012";
	if($bankid=='ABC')	$bankcode="100013";
	if($bankid=='BOCSH') $bankcode="100017";
	if($bankid=='CCB') $bankcode="100014";
	if($bankid=='CMB') $bankcode="100016";
	if($bankid=='SPDB') $bankcode="SPDB";
	if($bankid=='GDB') $bankcode="GDB";
	if($bankid=='BOCOM') $bankcode="100015";
	if($bankid=='PSBC') $bankcode="100025";
	if($bankid=='CNCB') $bankcode="100023";
	if($bankid=='CMBC') $bankcode="100018";
	if($bankid=='CEB') $bankcode="100024";
	if($bankid=='HXB') $bankcode="HXB";
	if($bankid=='CIB') $bankcode="100020";
	if($bankid=='BOS') $bankcode="SHB";
	if($bankid=='SRCB') $bankcode="SRCB";
	if($bankid=='PAB') $bankcode="100030";
	if($bankid=='weixin') $bankcode="100040";
	if($bankid=='wxh5') $bankcode="100072";
	if($bankid=='alipay') $bankcode="100067";
	if($bankid=='alipaywap') $bankcode="100073";
	if($bankid=='kjpay') $bankcode="100076";
	if($bankid=='qqrcode') $bankcode="100068";
	if($bankid=='qqwallet') $bankcode="100074";
	return $bankcode;
}
