    ...
    <div class="row">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">二维码有效期设置</h3>
            </div>
            <form class="panel-body form-horizontal form-padding" method="post" action="<?php echo U('Qrcode/valiHandle'); if(!empty($re)): ?>?id=<?php echo ($re["id"]); endif; ?>" onsubmit="return check()">
                <div class="form-group">
                    <label class="col-md-3 control-label">有效期</label>
                    <div class="col-md-2">
                        <input type="text" class="form-control" name="validity" value="<?php echo ($re["validity"]); ?>" id="validity">
                    </div>
                    <div class="col-md-6">
                        
                        <label class="col-md-8 control-label" style="text-align: left;">备注：单位为秒，填0或不填则默认长期有效</label>
                    </div>
                </div>
...
<script type="text/javascript">
    function check() {
        ...
        if (validity == null || $.trim(validity)=='') {
            alert('请输入有效期');
            return false;
        }
        return true;
