        ...
        <div class="panel-body">
                    ...
                    <div class="col-sm-12 table-toolbar">
                        <form action="<?php echo U('Order/index');?>" method="get">
                            <div class="form-group" style="margin-bottom: 10px;">
                                ...
                                <div class="input-group date form_datetime" data-date-format="yyyy-mm-dd hh:ii" data-link-field="dtp_input2" style="margin-right: 10px;">
                            ...
                            <div class="form-group" style="margin-right: 10px;margin-bottom: 10px;">
                                ...
                                <select class="form-control" name="noticestatus" id="dtp_select3">
                                    ...
                                    <option value="1" <?php if($noticestatus == '1'): ?>selected<?php endif; ?>>发送成功</option>
                                    <option value="0" <?php if($noticestatus == '0'): ?>selected<?php endif; ?>>发送失败</option>
                                </select>
                            </div>
                            <div class="form-group" style="margin-right: 10px;margin-bottom: 10px;">
            ...
            <div class="row">
                    <div class="col-sm-6 table-toolbar-left">
                        <p class="text-pink">总成功金额：￥ <?php echo number_format($money,2,".",","); ?> 元</p>
                    </div>
            ...
            <div class="table-responsive">
                <table id="demo-foo-row-toggler" class="table table-bordered text-center  toggle-circle">
                    ...
                    <?php if(is_array($lists)): foreach($lists as $key=>$v): ?><tr>
                            ...
                            <td>
                                <?php if($v['notice_status'] == 1): ?><div style="color: #68B83D">发送成功</div>
                                    <?php else: ?>
                                    <div style="color: #FF1111">发送失败</div><?php endif; ?>
                            ...
                            <td>
                                <?php echo date("Y-m-d H:i:s",$v["pay_time"]); ?>
                            </td>
                            <td>
