            ...
            <div class="pad-btm form-inline">
                <div class="row">
                    ...
                    <div class="col-sm-6 table-toolbar-left">
                        <a href="<?php echo U('Qrcode/index');?>" class="btn btn-default">微信</a>
                        <a href="#" class="btn btn-primary">支付宝</a>
                        <a href="<?php echo U('Qrcode/add');?>?type=2" class="btn btn-default"><i class="demo-pli-add"></i> 添加二维码</a>
                    </div>
            ...
            <div class="pad-btm form-inline">
                <div class="row">
                    <div class="col-sm-12 table-toolbar">
                        <form action="<?php echo U('Qrcode/aliCode');?>" method="get" onsubmit="return checkInput();">
                            ...
                            <div class="form-group" style="margin-right: 10px;margin-bottom: 10px;">
                                <a href="<?php echo U('Qrcode/decodeFailList');?>?type=2" class="btn btn-primary">待解码</a>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered text-center">
                    ...
                    <?php if(is_array($lists)): foreach($lists as $key=>$v): ?><tr>
                            ...
                            <td>
                                <a href="<?php echo U('Qrcode/show',array('code_id'=>$v['code_id'],'type'=>2));?>" target="_blank">查看</a>
                                |
                                <a href="#" onclick="delQrcode(<?php echo ($v['code_id']); ?>,'<?php echo ($v["qrcode"]); ?>',2)">删除</a>
                            </td>
