        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table class="table table-bordered text-center">
                    ...
                    <tr>
                        <td width="25%">用户名：</td>
                        <td><?php echo ($infos["user_name"]); ?></td>
                    </tr>

                    <tr>
                        <td width="25%">密码管理：</td>
                        <td>
                            <a href="<?php echo U('main/password');?>" class="btn btn-xs btn-default">
                                <i class="demo-pli-gear icon-lg icon-fw"></i> 密码重置
                            </a>
                        </td>
                    </tr>
                    </tbody>
