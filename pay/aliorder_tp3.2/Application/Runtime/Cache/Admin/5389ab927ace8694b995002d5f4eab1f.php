    ...
    <div class="row">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">系统密钥设置</h3>
            </div>
            <form class="panel-body form-horizontal form-padding" method="post" action="<?php echo U('Account/systemHandle'); if(!empty($re)): ?>?id=<?php echo ($re["id"]); endif; ?>" onsubmit="return check()">
                <div class="form-group">
                    <label class="col-md-3 control-label">系统密钥</label>
                    <div class="col-md-2">
                        <input type="text" class="form-control" name="api_key" value="<?php echo ($re["api_key"]); ?>" id="api_key">
                    </div>
                    <div class="col-md-5">
                        
                        <label class="col-md-8 control-label" style="text-align: left;">备注：与客户端交互唯一标识</label>
                    </div>
                </div>
