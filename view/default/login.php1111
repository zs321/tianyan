    ...
    <html>
        ...
        <head>
            ...
            <style>
                ...
                auto}.ltip a{color:#6B6D6E}.ltip a:hover{color:#337AB7}.gray{color:gray;font-weight:100}@media
                screen and (max-width:740px){#login{margin-top:30px}}
            </style>
        </head>
                                ...
                                <div class="content">
                                    <form action="/login/sigin" method="post">
                                        <div class="form-group">
                                            <input type="text" name="username" class="form-control" placeholder="邮箱账号/用户名"
                                        ...
                                        <div class="form-group">
                                            <label class="gray">
                                                <input type="checkbox" name="kl" value="yes" checked>
                                                &nbsp;保持登录状态
                                            </label>
                                        </div>
                                    </form>
