...
<div class="polyPay product">
	<div class="banner polyPay_banner">
		<div class="main">
			...
			<a href="/demo" class="btn">立即体验</a><a href="/login" class="btnr">下载SDK</a>
		</div>
		<ul class="key-word">
			<li>极速</li>
			<li>便捷</li>
...
<div class="footer">
	<div class="main clearfix">
		...
		<dl>
			<dt>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;©2017 四川虎付网络科技有限公司&nbsp;&nbsp;&nbsp;&nbsp;鲁ICP备15020510号&nbsp;&nbsp;<img style="position:relative;margin-top:-4px;" src="http://www1.pconline.com.cn/footer/images/ft-ghs.png" alt="图片说明" /></dt>
